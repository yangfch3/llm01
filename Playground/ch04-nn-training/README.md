...
| `02_optimizer_compare.py` | SGD / Momentum / Adam / AdamW 在 sin 拟合任务上的 loss 对比 | 同上 |
| `03_lr_schedule.py` | 四种 lr schedule 的 ASCII 曲线（Constant / Step / Cosine / Warmup+Cosine） | 同上 |
